"""Sphinx configuration for pipeworks_mud_mapper documentation.
...
autoapi_type = "python"
autoapi_dirs = [
    str(project_root / "src" / "pipeworks_mud_mapper"),
]
autoapi_options = [
    "members",
    "undoc-members",
...
# -- Intersphinx mapping -----------------------------------------------------
# Note: Dash and Plotly don't provide standard Sphinx inventories
intersphinx_mapping = {
