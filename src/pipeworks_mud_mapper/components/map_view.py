...
def _add_vertical_indicator(fig: go.Figure, x: int, y: int, direction: str) -> None:
    ...
    .. deprecated::
        This function is deprecated and no longer called by the main
        rendering path. With the flattened view, vertical exits are
        indicated by text labels instead of triangle markers.

    Places a colored triangle marker near a room to indicate that an
    exit leads to a different Z-level.
    ...
    See Also
    --------
    _add_vertical_exit_labels : The replacement for this function
    """
